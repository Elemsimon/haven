                  ...
                  <article key={room._id} className="bg-stone-900 group">
                    <div className="relative h-60 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4 glass px-3 py-1.5">
                        <span className="font-body text-xs text-white/70">from <span className="text-white font-medium">${discountPrice}</span><span className="text-white/40">/night</span></span>
                      </div>
                      {room.discount > 0 && (
                    ...
                    <div className="p-7 border border-white/5 border-t-0">
                      ...
                      {room.discount > 0 && <p className="font-body text-xs text-stone-600 line-through mb-1">${room.price}/night</p>}
